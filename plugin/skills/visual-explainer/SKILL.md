...
**Usage:**
```bash
bash ${CLAUDE_PLUGIN_ROOT}/skills/visual-explainer/scripts/share.sh <html-file>
```

**Example:**
```bash
bash ${CLAUDE_PLUGIN_ROOT}/skills/visual-explainer/scripts/share.sh ~/.agent/diagrams/my-diagram.html
